...
public class StringEncrypter {
	 ...
	 * @throws Exception
	 */
	public StringEncrypter(String key, String initialVector, String encoding) throws Exception {
		...
		this.key = new SecretKeySpec(md5.digest(key.getBytes(encoding)), "AES");
		this.initalVector = new IvParameterSpec(md5.digest(initialVector.getBytes(encoding)));
	}
	 ...
	 * @throws Exception
	 */
	public String encrypt(String value, String encoding) throws Exception {
		if (value == null)
			value = "";
		...
		byte[] utf8Value = value.getBytes(encoding);
	 ...
	 * @throws Exception
	 */
	public String decrypt(String value, String encoding) throws Exception {
		...
		return new String(decryptedValue, encoding);
	}
}
